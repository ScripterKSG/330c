...
# This script is part of the basic intro to probability in RHE 330C. 
# Note: Many calculations in the script are random. That means the numbers will be slightly different when you run them at home. 
